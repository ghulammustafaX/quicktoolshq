...
// SVG Icons - Tiny size for minimal design
  ...
  return (
    <Layout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Featured Article - With creative badge design */}
        {featuredPost && (
          <div className="mb-16">
        ...
        {/* Latest Articles - Creative and simple design */}
        <div className="mb-16">
                ...
                <div className="group bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100">
                  <div className="bg-gradient-to-br from-[#00B5AD] to-[#009B94] p-6 text-white relative overflow-hidden">
                    ...
                    <div className="text-center pt-8">
                      <div className="w-10 h-10 mx-auto mb-4 text-white/90 group-hover:text-white transition-colors duration-300">
                        <BookOpenIcon className="w-full h-full" />
                      </div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="w-6 h-6 bg-[#00B5AD] rounded-full flex items-center justify-center group-hover:scale-110 transition-transform">
